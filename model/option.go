...
func InitOptionMap() {
	...
	config.GlobalOption.RegisterBool("WeChatRegisterEnabled", &config.WeChatRegisterEnabled)
	config.GlobalOption.RegisterBool("WebAuthnEnabled", &config.WebAuthnEnabled)
